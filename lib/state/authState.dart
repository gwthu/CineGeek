...
class AuthState extends AppState {
  ...
  Future<String?> signUp(UserModel userModel,
    ...
    try {
      ...
      _firebaseAuth.currentUser!.updateDisplayName(userModel.displayName);
    ...
    try {
      if (image == null) {
        ...
        storageReference.getDownloadURL().then((fileURL) async {
          ...
          _firebaseAuth.currentUser!.updatePhotoURL(fileURL);
  ...
  getProfileUser({String? userProfileId}) async {
    try {
      ...
      if (documentSnapshot.data() != null) {
        _profileUserModelList!.add(UserModel.fromJson(
  ...
  void _onProfileChanged(DocumentSnapshot event) {
    if (event.data() != null) {
      final updatedUser =
          UserModel.fromJson(event.data() as Map<dynamic, dynamic>?);
