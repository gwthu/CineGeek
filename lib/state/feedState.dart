...
class FeedState extends AppState {
    ...
    try {
      ...
      if (model != null) {
        ...
        _tweetCollection.doc(postID).get().then((DocumentSnapshot snapshot) {
          ...
          _tweetDetail = FeedModel.fromJson(map as Map<dynamic, dynamic>);
          ...
          _tweetDetail!.replyTweetKeyList!.forEach((tweetKey) {
            ...
            _tweetCollection
              ...
              if (snapshot.data != null) {
                var map = snapshot.data()!;
                final commentmodel =
                    FeedModel.fromJson(map as Map<dynamic, dynamic>);
  ...
  Future<FeedModel?> fetchTweet(String? postID) async {
    ...
    /// If tweet is not available in feedlist then need to fetch it from firebase
      ...
      dynamic model = await kDatabase.child('tweet').child(postID).once().then(
  ...
  _onTweetChanged(DocumentSnapshot event) {
    ...
    var model = FeedModel.fromJson(event.data() as Map<dynamic, dynamic>);
    model.key = event.id;
  ...
  _onTweetAdded(DocumentSnapshot event) {
    FeedModel tweet = FeedModel.fromJson(event.data() as Map<dynamic, dynamic>);
    tweet.key = event.id;
